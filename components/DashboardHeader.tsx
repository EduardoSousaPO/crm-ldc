      ...
      <div className="px-6">
        <div className="flex items-center justify-between h-14">
            ...
            <div className="flex items-center gap-1">
              {/* Search - Mobile */}
              <button 
                className="md:hidden p-2 hover:bg-gray-100 rounded-md transition-colors opacity-50 cursor-not-allowed"
                disabled
                title="Funcionalidade em desenvolvimento"
              >
              ...
              {/* Notifications */}
              <button 
                className="p-2 hover:bg-gray-100 rounded-md transition-colors relative opacity-50 cursor-not-allowed"
                disabled
                title="Funcionalidade em desenvolvimento"
              >
